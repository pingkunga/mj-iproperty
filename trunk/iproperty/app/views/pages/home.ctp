...
?>
                    ...
                    <div>- โกดังสินค้าให้เช่าของ Iproperty บริการท่านด้วยพื้นที่เก็บสินค้าได้มาตรฐานดีพร้อม</div>
                    <div>- ตั้งอยู่บนถนนทรานซิสเตอร์ กรุงเทพฯ</div>
                    <div>- การคมนาคมสะดวก เดินทางได้ทั้งบก ทางเรือ และทางอากาศ</div>
